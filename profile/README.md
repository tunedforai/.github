...
**[x402.tunedfor.ai](https://x402.tunedfor.ai)** &nbsp;|&nbsp; [catalog](https://x402.tunedfor.ai/catalog) &nbsp;|&nbsp; [demo](https://x402.tunedfor.ai/demo) &nbsp;|&nbsp; [repo](https://github.com/tunedforai/x402)
...
- Whether spot buyers are leading perp — a leading indicator
- Whether volume is distributed or concentrated on one venue (manipulation signal)
- Macro backdrop: DXY, VIX, fear/greed regime

All returned as typed JSON fields your agent can branch on directly.
...
Wire to Claude Desktop or Cursor via `mcp_server.py`. Six tools: `raw_data`, `analyze_market`, `analyze_orderflow`, `analyze_full`, `analyze_address`, `signal_performance`.

[Full MCP setup guide](https://github.com/tunedforai/x402/blob/main/docs/mcp.md)
